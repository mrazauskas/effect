...
export const layerClient: Layer.Layer<
  ...
  never,
  ShardingConfig.ShardingConfig | Pods.RpcClientProtocol | MessageStorage
> = Sharding.layer.pipe(
...
export const layerHttpMsgPack: Layer.Layer<
  Sharding.Sharding | Pods.Pods,
  ConfigError,
  HttpClient.HttpClient | HttpServer.HttpServer | MessageStorage
...
export const layerWebsocketMsgPack: Layer.Layer<
  Sharding.Sharding | Pods.Pods,
  ConfigError,
  Socket.WebSocketConstructor | HttpServer.HttpServer | MessageStorage
