 ...
 * By default, it uses the `HttpRouter.Default` tag.
 *
 * It uses the `RpcSerialization.layerMsgPack` layer for serialization.
 *
 * @since 1.0.0
 * @category Layers
 */
export const layerHttpMsgPack: Layer.Layer<
  ShardManager.ShardManager,
  never,
  Storage | PodsHealth.PodsHealth | HttpClient.HttpClient | HttpServer.HttpServer | ShardManager.Config | ShardingConfig
> = Layer.provide(layerHttp, RpcSerialization.layerMsgPack)
 ...
 * By default, it uses the `HttpRouter.Default` tag.
 *
 * It uses the `RpcSerialization.layerNdjson` layer for serialization.
 *
 * @since 1.0.0
 * @category Layers
 */
export const layerHttpNdjson: Layer.Layer<
  ...
  never,
  Storage | PodsHealth.PodsHealth | HttpClient.HttpClient | HttpServer.HttpServer | ShardManager.Config | ShardingConfig
> = Layer.provide(layerHttp, RpcSerialization.layerNdjson)
...
export const layerWebsocketMsgPack: Layer.Layer<
  ...
  | ShardManager.Config
  | ShardingConfig
> = Layer.provide(layerWebsocket, RpcSerialization.layerMsgPack)
 ...
 * By default, it uses the `HttpRouter.Default` tag.
 *
 * It uses the `RpcSerialization.layerJson` layer for serialization.
 *
 * @since 1.0.0
 * @category Layers
 */
export const layerWebsocketJson: Layer.Layer<
  ...
  | ShardManager.Config
  | ShardingConfig
> = Layer.provide(layerWebsocket, RpcSerialization.layerJson)
