...
import type { Config } from "../ShardManager.js"
import { Storage } from "../Storage.js"

/** @internal */
export class State {
  static fromStorage = Effect.fnUntraced(function*(config: Config["Type"]) {
    ...
    const storedAssignments = yield* storage.getShardAssignments
