...
describe("Model", () => {
    it.effect("insert returns result", () => Effect.gen(function* () {
    ...
    }).pipe(Effect.provide(MysqlContainer.ClientLive), Effect.catchTag("ContainerError", () => Effect.void)), { timeout: 60_000 });
    it.effect("insertVoid", () => Effect.gen(function* () {
        const repo = yield* Model.makeRepository(User, {
            tableName: "users",
            idColumn: "id",
            spanPrefix: "UserRepository"
    ...
    it.scopedLive("insert data loader returns result", () => Effect.gen(function* () {
    ...
    it.scopedLive("findById data loader", () => Effect.gen(function* () {
        const repo = yield* Model.makeDataLoaders(User, {
            tableName: "users",
            idColumn: "id",
            spanPrefix: "UserRepository",
    ...
    it.effect("update returns result", () => Effect.gen(function* () {
        const repo = yield* Model.makeRepository(User, {
            tableName: "users",
            idColumn: "id",
            spanPrefix: "UserRepository"
